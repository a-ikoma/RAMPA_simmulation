...
def create_defined_arrays(data_avg, yerr):
    ...
    indices = [0, min_idx, median_idx, max_idx]
    ...
    yerr_def = [
        [yerr[0][i] for i in indices],
        [yerr[1][i] for i in indices]
    ]
...
for env in envs:
    for allocCase in cases:
                ...
                for stagePol in stagePolicy[pol]:
                    ...
                    while True:
                        ...
                        if tmp[2]!="0":
                            break
                        if tmp[1]=="1":
                            allocatedCnt1.append(float(tmp[9]))
                        elif tmp[1]=="2":
                            allocatedCnt2.append(float(tmp[9]))
                        elif tmp[1]=="3":
                            allocatedCnt3.append(float(tmp[9]))  
                        elif tmp[1]=="4":
                            allocatedCnt4.append(float(tmp[9]))
                        elif tmp[1]=="5":
                            allocatedCnt5.append(float(tmp[9]))
                        elif tmp[1]=="6":
                            allocatedCnt6.append(float(tmp[9]))  
                        time+=1
        ...
        print(data1_max)
        yerr1 = [
            [mean - min_val for mean, min_val in zip(data1_avg, data1_min)],
            [max_val - mean for mean, max_val in zip(data1_avg, data1_max)]
        ]

        yerr2 = [
            [mean - min_val for mean, min_val in zip(data2_avg, data2_min)],
            [max_val - mean for mean, max_val in zip(data2_avg, data2_max)]
        ]

        yerr3 = [
            [mean - min_val for mean, min_val in zip(data3_avg, data3_min)],
            [max_val - mean for mean, max_val in zip(data3_avg, data3_max)]
        ]

        yerr4 = [
            [mean - min_val for mean, min_val in zip(data4_avg, data4_min)],
            [max_val - mean for mean, max_val in zip(data4_avg, data4_max)]
        ]

        yerr5 = [
            [mean - min_val for mean, min_val in zip(data5_avg, data5_min)],
            [max_val - mean for mean, max_val in zip(data5_avg, data5_max)]
        ]

        yerr6 = [
            [mean - min_val for mean, min_val in zip(data6_avg, data6_min)],
            [max_val - mean for mean, max_val in zip(data6_avg, data6_max)]
        ]
        ...
        plt.axhline(100, color="red", linestyle="dashed")


        index = np.arange(len(label))
        plt.legend(["Acceptable execution time"],loc="upper center",fontsize=16, ncol=4,bbox_to_anchor=(0.5, 1.25))
        plt.ylabel('Average execution time (ms)',fontsize=14)
        plt.xticks(np.arange(4),["RAMPA","PE\n(Best)","PE\n(Median)","PE\n(Worst)"],fontsize=10,rotation=90)
        plt.tight_layout()
        plt.ylim(0, 110)
        plt.savefig("./responseTime_service1.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)
        ...
        plt.axhline(200, color="red", linestyle="dashed")


        index = np.arange(len(label))
        plt.legend(["Acceptable execution time"],loc="upper center",fontsize=16, ncol=4,bbox_to_anchor=(0.5, 1.2))
        plt.ylabel('Average execution time (ms)',fontsize=14)
        plt.xticks(np.arange(4),["RAMPA","PE\n(Best)","PE\n(Median)","PE\n(Worst)"],fontsize=10,rotation=90)
        plt.tight_layout()
        plt.ylim(0, 210)
        plt.savefig("./responseTime_service2.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)
        ...
        plt.tight_layout()
        plt.ylim(0, 60)
        plt.savefig("./responseTime_service3.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)
        ...
        plt.axhline(800, color="red", linestyle="dashed")
        ...
        plt.tight_layout()
        plt.ylim(0, 810)
        plt.savefig("./responseTime_service4.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)
        ...
        plt.axhline(10000, color="red", linestyle="dashed")
        ...
        plt.tight_layout()
        plt.ylim(0, 10010)
        plt.savefig("./responseTime_service5.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)
        ...
        plt.axhline(5000, color="red", linestyle="dashed")
        ...
        plt.tight_layout()
        plt.ylim(0, 5010)
        plt.savefig("./responseTime_service6.pdf",dpi=130,bbox_inches = 'tight', pad_inches = 0.05)